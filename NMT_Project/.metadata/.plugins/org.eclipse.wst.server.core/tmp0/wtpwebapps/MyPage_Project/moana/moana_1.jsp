...
<body>
  <section class = "section_menu">
             ...
             <section class = "section_content">
                <article>
                    <center>
                     <label style =  "font-size:40pt">Moana</label><br>
                     <label style =  "font-size:20pt;">모아나</label><br><br><br>
                 </center>
                     <article style = "text-align: center"><img src = "../moana_img/moa.jpg" width="33%" height="40%"></article> 
                     <a href = "moana_2.jsp"><article class = "next_page"><label style="font-weight: 800">CHARACTER</label><img src = "../snow_img/nn.png"></article></a>
                </article>
             </section>
