...
<section class = "section_menu">
            ...
            <section class = "section_content">
               <article>
                   <center>
                    <label style =  "font-size:40pt">Ratatouille</label><br>
                    <label style =  "font-size:20pt;">라따뚜이</label><br><br><br>
                </center>
                    <article style = "text-align: center"><img src = "../rata_img/ratapos.jpg"></article> 
                    <a href = "rata_2.jsp"><article class = "next_page"><label style="font-weight: 800">CHARACTER</label><img src = "../snow_img/nn.png"></article></a>
               </article>
            </section>
