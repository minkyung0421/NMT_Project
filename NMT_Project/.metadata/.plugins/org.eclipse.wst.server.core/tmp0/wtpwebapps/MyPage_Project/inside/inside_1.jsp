...
<body>
 <section class = "section_menu">
            ...
            <section class = "section_content">
               <article>
                   <center>
                    <label style =  "font-size:40pt">Inside Out</label><br>
                    <label style =  "font-size:20pt;">인사이드 아웃</label><br><br><br>
                </center>
                    <article style = "text-align: center"><img src = "../inside_img/inside.jpg" width="35%" height="45%" ></article> 
                    <a href = "inside_2.jsp"><article class = "next_page"><label style="font-weight: 800">CHARACTER</label><img src = "../snow_img/nn.png"></article></a>
               </article>
            </section>
