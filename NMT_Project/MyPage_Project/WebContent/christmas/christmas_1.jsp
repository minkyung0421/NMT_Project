...
<body>
	 <section class = "section_menu">
             ...
             <section class = "section_content">
                <article>
                    <center>
                     <label style =  "font-size:40pt">The Nightmare before Christmas</label><br>
                     <label style =  "font-size:20pt;">크리스마스의 악몽</label><br><br><br>
                 </center>
                     <article style = "text-align: center"><img src = "../christmas_img/chistma.jpg" width="33%" height="40%"></article> 
                     <br>
                     <a href = "christmas_2.jsp"><article class = "next_page"><label style="font-weight: 800">CHARACTER</label><img src = "../snow_img/nn.png"></article></a>
                </article>
             </section>
